...
// ISPISI EKRANA TJ. STATICNIH ELEMENATA EKRANA MENIJA
void screen0();
void screen1();
void screen2();
void screen3();
void screen4();
void Instrukcije();
// ZA OPCIJE MENIJA 1 i 2 SE KORISTE OVE 2 DA SE OSTAVI CISTA KONZOLA POSTO IMA PROMJENLJIVIH ELEMENATA
